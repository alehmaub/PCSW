...
public class UserServiceTests extends AbstractTestNGSpringContextTests {
    ...
    /**
     * Testeamos codigo de reponse entity ok value. pendiente por error de database. 
     * @throws Exception
     */
    // @Test
    ...
    void testGuardadoTokenNuevo() throws Exception{
        ...
        String tokenRepositorio = userRepository.getOne((long)10).getToken();
        Assertions.assertEquals("token",tokenRepositorio );
